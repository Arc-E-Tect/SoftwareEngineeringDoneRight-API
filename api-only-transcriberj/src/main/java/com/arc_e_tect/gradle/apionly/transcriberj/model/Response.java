 ...
 *                    range such as {@code 4XX}, or {@code default}
 * @param description {@code description}, or {@code null}
 * @param content     {@code content} in declaration order, or {@code null}
 * @param other       every other key -- {@code headers}, {@code links} -- as parsed; a
 *                    {@code $ref} response has only this
 */
public record Response(String status, String description, List<MediaType> content, Map<String, Object> other) {
}
